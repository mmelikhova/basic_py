...
def test_phones_on_home_page(app):
    ...
    assert contact_from_homepage.home_num == clear(contact_from_editpage.home_num)
    assert contact_from_homepage.work_num == clear(contact_from_editpage.work_num)
    assert contact_from_homepage.mob_num == clear(contact_from_editpage.mob_num)
    assert contact_from_homepage.phone2 == clear(contact_from_editpage.phone2)
